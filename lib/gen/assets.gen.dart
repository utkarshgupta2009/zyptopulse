...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/appearance.svg
  SvgGenImage get appearance =>
      const SvgGenImage('assets/icons/appearance.svg');
  ...
  /// File path: assets/icons/markets.svg
  SvgGenImage get markets => const SvgGenImage('assets/icons/markets.svg');
  ...
  /// File path: assets/icons/price_gain_indicator.svg
  SvgGenImage get priceGainIndicator =>
      const SvgGenImage('assets/icons/price_gain_indicator.svg');

  /// File path: assets/icons/price_loss_indicator.svg
  SvgGenImage get priceLossIndicator =>
      const SvgGenImage('assets/icons/price_loss_indicator.svg');
  ...
  /// File path: assets/icons/trades.svg
  SvgGenImage get trades => const SvgGenImage('assets/icons/trades.svg');

  /// File path: assets/icons/wallets.svg
  SvgGenImage get wallets => const SvgGenImage('assets/icons/wallets.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/onboarding_person.svg
  SvgGenImage get onboardingPerson =>
      const SvgGenImage('assets/images/onboarding_person.svg');

  /// File path: assets/images/splash_screen.svg
  SvgGenImage get splashScreen =>
      const SvgGenImage('assets/images/splash_screen.svg');

  /// List of all assets
  List<SvgGenImage> get values => [background, onboardingPerson, splashScreen];
}
